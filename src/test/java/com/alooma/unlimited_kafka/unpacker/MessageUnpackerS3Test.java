...
class MessageUnpackerS3Test {
    ...
    @Test
    void badTypeException() {
        AmazonS3 s3 = mock(AmazonS3.class);

        Capsule<String> capsuleMock = mock(Capsule.class);
        MessageUnpackerS3<String> unpacker = new MessageUnpackerS3<>(s3, "bucket", String::new);
    ...
    void unpackException() {
        AmazonS3 s3 = mock(AmazonS3.class, RETURNS_DEEP_STUBS);
        S3Object s3Object = mock(S3Object.class);
        MessageUnpackerS3<String> unpacker = new MessageUnpackerS3<>(s3, "bucket", (bytes) -> {throw new RuntimeException("Not Int");});
        ...
        assertThrows(UnpackException.class, () -> unpacker.unpackMessage(Capsule.remoteCapsule("topic/000")));
    }
